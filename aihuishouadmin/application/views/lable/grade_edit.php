    ...
    <div class="layui-row">
        <form method="post" class="layui-form" action="" name="basic_validate" id="tab">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline" style="width: 300px;">
					<input type="text" id="lcontents" name="lcontents" lay-verify="lcontents"
						   autocomplete="off" value="<?php echo $lcontents ?>" class="layui-input">
				</div>
			</div>
            <input type="hidden" name="uid" id="uid" value="<?php echo $lid ?>">
            <div class="layui-form-item">
    ...
    layui.use(['form', 'layer'],
        function () {
            ...
            form.verify({
				...
				lcontents: function (value) {
					if ($('#lcontents').val() == "") {
						return '请输入返点比例。';
					}
					if(isNaN($('#lcontents').val())){
						return '只能输入数字。';
					}
				},
            });
